...
const BOTS = [
   ...
   },
   {
      ...
      port: 8002,
      account: {
         username: "Heartless_MC2",  // Change these usernames
         password: "notasecurepassword123",
         type: "offline"
      }
   },
   {
      ...
      port: 8003,
      account: {
         username: "Heartless_MC3",  // Change these usernames
         password: "notasecurepassword123",
         type: "offline"
      }
   },
   {
      ...
      port: 8004,
      account: {
         username: "Heartless_MC4",  // Change these usernames
         password: "notasecurepassword123",
         type: "offline"
      }
   },
   {
      ...
      port: 8005,
      account: {
         username: "Heartless_MC5",  // Change these usernames
         password: "notasecurepassword123",
         type: "offline"
      }
   }
